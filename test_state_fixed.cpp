...
constexpr Amount USDTG_DECIMALS = 1000000LL; // 6 decimals to avoid overflow
...
struct Account {
    Nonce nonce;
    std::map<AssetID, Amount> balances;
